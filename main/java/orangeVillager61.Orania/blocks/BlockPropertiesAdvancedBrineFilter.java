...
public class BlockPropertiesAdvancedBrineFilter extends BasicBlock implements IMetaBlockName{
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumFacing side, float hitX, float hitY, float hitZ) {
		...
		if (state.getValue(TYPE) == EnumType.FULL){
			...
			EntityItem entityitem1 = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(Items.bucket, 1));
			EntityItem entityitem2 = new EntityItem(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(OraniaItems.bucket_of_brine, 1));
